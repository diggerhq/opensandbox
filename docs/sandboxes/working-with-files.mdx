...
All file operations are streamed end-to-end using 256KB chunks. The maximum file transfer size is **2 GB** per file. Files up to 2 GB transfer reliably at ~20 MB/s.
