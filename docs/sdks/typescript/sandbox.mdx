...
The `Sandbox` class is the main entry point to OpenComputer. Use it to create new sandboxes, connect to existing ones, and access all sub-modules (commands, filesystem, PTY, templates).
...
<ParamField body="opts" type="SandboxOpts" optional>
  <Expandable title="properties">
    ...
    <ParamField body="project" type="string" optional>
      Project name. Inherits the project's config defaults and [sealed secrets](/sdks/typescript/projects).
    </ParamField>
  </Expandable>
</ParamField>
