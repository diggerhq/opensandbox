...
The `Sandbox` class is the main entry point to OpenComputer. It supports both manual lifecycle management and async context managers.
...
<ParamField body="template" type="str" default="default">
...
<ParamField body="project" type="str | None" default="None">
  Project name. Inherits the project's config defaults and [sealed secrets](/sdks/python/projects).
</ParamField>
