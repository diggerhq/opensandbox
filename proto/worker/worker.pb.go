...
var file_proto_worker_worker_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_proto_worker_worker_proto_goTypes = []any{
	...
	nil, // 55: worker.CreateSandboxRequest.SecretEnvsEntry
	nil, // 56: worker.ExecCommandRequest.EnvsEntry
	nil, // 57: worker.ExecSessionCreateRequest.EnvsEntry
}
var file_proto_worker_worker_proto_depIdxs = []int32{
	...
	55, // 2: worker.CreateSandboxRequest.secret_envs:type_name -> worker.CreateSandboxRequest.SecretEnvsEntry
	6,  // 3: worker.ListSandboxesResponse.sandboxes:type_name -> worker.GetSandboxResponse
	56, // 4: worker.ExecCommandRequest.envs:type_name -> worker.ExecCommandRequest.EnvsEntry
	...
	57, // 8: worker.ExecSessionCreateRequest.envs:type_name -> worker.ExecSessionCreateRequest.EnvsEntry
	...
	47, // 32: worker.SandboxWorker.PrepareMigrationIncoming:input_type -> worker.PrepareMigrationIncomingRequest
	49, // 33: worker.SandboxWorker.LiveMigrate:input_type -> worker.LiveMigrateRequest
	51, // 34: worker.SandboxWorker.CompleteMigrationIncoming:input_type -> worker.CompleteMigrationIncomingRequest
	...
	48, // 57: worker.SandboxWorker.PrepareMigrationIncoming:output_type -> worker.PrepareMigrationIncomingResponse
	50, // 58: worker.SandboxWorker.LiveMigrate:output_type -> worker.LiveMigrateResponse
	52, // 59: worker.SandboxWorker.CompleteMigrationIncoming:output_type -> worker.CompleteMigrationIncomingResponse
