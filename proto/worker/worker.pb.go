...
type CreateSandboxRequest struct {
	...
	// Names of env vars that originated from a SecretStore and must be tokenized
	// by the secrets proxy. Envs not in this list reach the guest as plaintext.
	// Empty = no envs are sealed.
	SealedEnvKeys []string `protobuf:"bytes,15,rep,name=sealed_env_keys,json=sealedEnvKeys,proto3" json:"sealed_env_keys,omitempty"`
...
func (x *CreateSandboxRequest) GetSealedEnvKeys() []string {
	if x != nil {
		return x.SealedEnvKeys
	}
	return nil
}
...
const file_proto_worker_worker_proto_rawDesc = "" +
	"\n" +
	"\x19proto/worker/worker.proto\x12\x06worker\"\x81\x06\n" +
	...
	"\x14secret_allowed_hosts\x18\x0e \x03(\v24.worker.CreateSandboxRequest.SecretAllowedHostsEntryR\x12secretAllowedHosts\x12&\n" +
	"\x0fsealed_env_keys\x18\x0f \x03(\tR\rsealedEnvKeys\x1a7\n" +
	"\tEnvsEntry\x12\x10\n" +
